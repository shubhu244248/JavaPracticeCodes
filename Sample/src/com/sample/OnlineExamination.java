...
{  
    ...
    {     
        ...
        newPanel.add(userLabel, constraints);
        ...
        constraints.gridx = 0;
        constraints.gridy = 1;
        newPanel.add(passLabel, constraints);
...
//            form.setUndecorated(true); // Removes the title bar and border of the window
//            form.setExtendedState(JFrame.MAXIMIZED_BOTH); // Sets the state of the window to full screen
        }  
        catch(Exception e)  
        {     
